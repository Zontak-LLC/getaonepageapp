...
export const metadata: Metadata = {
  ...
  description:
    "Zontak builds fast, mobile-first one-page app websites from $50/year. Full service: build, deploy, and maintain. AI-first creative company.",
  keywords: [
    "one page app",
    "website builder",
    "AI website",
  ...
  openGraph: {
    title: "Zontak | One-Page App Websites — from $50/year",
    description:
