  ...
  return (
    ...
    >
      ...
      <p className="text-foreground/50 max-w-md mx-auto mb-8">
        Sign in with Google and submit one free project brief. Our AI pipeline
      ...
      {session?.user ? (
        ...
        <button
          ...
          className="inline-flex items-center gap-3 px-8 py-4 bg-orange text-warm-black font-semibold rounded-full text-lg hover:bg-orange-dark hover:shadow-[0_0_40px_rgba(240,125,46,0.3)] transition-all"
        >
      ...
      <p className="mt-4 text-xs text-foreground/30">
        1 free project per Google account. No payment required.
      </p>
    </div>
  );
}
